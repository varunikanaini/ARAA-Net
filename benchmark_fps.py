...
def main():
    ...
    parser.add_argument('--input-h', type=int, default=448, help='Height of dummy input image')
    parser.add_argument('--input-w', type=int, default=448, help='Width of dummy input image')
