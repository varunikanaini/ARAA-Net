...
def main():
    ...
    parser.add_argument('--image-index', type=int, default=15, help='Index of the test image to visualize')
    ...
    exp_name = f"lasa_focal_{args.dataset_name.replace('TSRS_RSNA-', '').lower()}_{args.backbone}"
