...
def main():
    parser = argparse.ArgumentParser(description='Visualize LASA-VGG-Unet predictions')
    parser.add_argument('--dataset-name', type=str, default='TSRS_RSNA-Epiphysis')
    parser.add_argument('--image-index', type=int, default=10, help='Index of the test image to visualize')
    parser.add_argument('--scale-h', type=int, default=448)
    parser.add_argument('--scale-w', type=int, default=448)
    ...
    # Load image from the 'test' split
