# /kaggle/working/araa/ARAA-Net/daseg.py (FINAL VERSION - YOUR CODE + FIXES)

import torch
import torch.nn as nn
import torch.nn.functional as F
import torchvision.models as models
from lasa import LASA # Import the new LASA module

# --- YOUR ORIGINAL get_backbone FUNCTION IS PRESERVED ---
...
# --- YOUR ORIGINAL ATTENTION AND CONTEXT BLOCKS ARE PRESERVED ---
...
# --- daseg class with LASA INTEGRATION and UNBOUNDLOCALERROR FIX ---
class daseg(nn.Module):
    def __init__(self, backbone_name='resnet50'):
        ...
        # --- CHANGE 1: Instantiate LASA modules ---
    ...
    def forward(self, x):
        ...
        # --- CHANGE 2: Fix UnboundLocalError by separating assignments ---
        l0 = self.layer0(x)
        l1 = self.layer1(l0)

        # --- CHANGE 3: Apply LASA modules in the forward pass ---
        ...
        # Use the LASA-refined features in the decoder path
